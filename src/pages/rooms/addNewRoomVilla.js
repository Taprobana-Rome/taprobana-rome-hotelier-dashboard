...
const Page = () => {
  ...
  const notifySuccess = () =>
    toast.success("Villa Added Successfuly", {
      position: "top-right",
      autoClose: 5000,
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      type: Yup.string().max(255).required("Villa type is required"),
  ...
  return (
    <>
      <Head>
        <title>New Villa | TaprobanaRome</title>
      </Head>
      <Box
        component="main"
        A
      ...
      >
        <Container maxWidth={false}>
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Typography color="text.primary">Add new Villa</Typography>
          </Breadcrumbs>
          <Box sx={{ mt: 3 }}>
            <h1>Add new Villa</h1>
            <Box mt={5} mx={5}>
